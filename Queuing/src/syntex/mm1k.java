 ...
 * @author Hp
 */
public class mm1k extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(k, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jPanel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel14MouseClicked
        if(valid(t1.getText())&&valid(t2.getText())&&valid(k.getText())){
            x = tst(t1.getText());
            y = tst(t2.getText());
            kk = tst(k.getText());
            double h,u;
            ...
            if(r==1){
             ...
             ld = (h*(1-pk));
                ...
                l = r * ((1-((kk+1)*Math.pow(r,kk))+(Math.pow(r,kk+1)*kk))/((1-r)*(1-Math.pow(r,kk+1))));
                pk = Math.pow(r,kk) * ((1-r)/(1-Math.pow(r,kk+1)));
                ld = (h*(1-pk));
            }
            w = l/ld;
            wq = w - y;
